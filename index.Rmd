...
Try to work through *Exercise_2_1.R*. The exercise will teach you how to calculate single and multiple landscape metrics.
...
In case you run into problems or have any questions, please contact us at any time via *Zoom* private chat.
Also, there will be a public Q&A plenary session at **XX:XX pm**.
...
```{r, show_lsm, echo = FALSE, cache=TRUE}
show_lsm(augusta_nlcd, labels = FALSE, 
         class = 42, what = "lsm_p_area") + 
...
--
```{r moving_window_plot, echo = FALSE, cache=TRUE}
...
```{r moving_window_result, echo = FALSE, out.width = "40%", cache=TRUE}
